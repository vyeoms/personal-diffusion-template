...
import numpy as np
import torch
# Magnitude preserving functions and modules from Karras et al's codebase.
from utils.mp_utils import normalize, resample, mp_silu, mp_sum, mp_cat # Functions
from utils.mp_utils import MPConv, MPFourier # Modules
...
class UNet(torch.nn.Module):
    def __init__(self,
        ...
        num_blocks          = 8,            # Number of residual blocks per resolution.
        ...
        **block_kwargs,                     # Arguments for Block.
        ...
        # Embedding.
        self.emb_fourier = MPFourier(cnoise, bandwidth=2)
